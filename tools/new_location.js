...
- **Район:** ${districtRaw}
${rayon ? `- **Дополнение к адресу:** ${rayon}\n` : ''}- **Адрес:** ⚠️ Требуется уточнение
- **Зона:** ${zone}
...
⚠️ 2–3 предложения о настроении и ощущении места.
...
| Канал | |
|---|---|
| **Свет** | ⚠️ Требуется уточнение |
| **Звук** | ⚠️ Требуется уточнение |
| **Запах** | ⚠️ Требуется уточнение |
