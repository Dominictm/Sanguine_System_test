...
const POSITIVE_TMPL = scene => "solid pure black background, jet black background filling the entire square canvas, "
  ...
  + "deep crimson and black color palette, ornamental aged copper and gold border with fine filigree linework, "
  + "burnished copper metallic accents and copper patina glints in the ornament, "
