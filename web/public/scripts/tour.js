...
const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: 'Вампиры, смертные и феи домена. Клик по карточке открывает досье: внешность, дисциплины, связи, дневники. Фильтры сверху сужают список по линейке, статусу и принадлежности.',
  },
  {
  ...
  },
  {
    ...
    label: 'Шаг 4 · 6',
    title: 'Веди сессию вживую',
    body: 'Экран для стола: сценарий модуля разворачивается по сценам, рядом — НПС, музыка и заметки. Плавающая кнопка 🎲 в углу экрана бросает кубики по листу персонажа в любой момент, на любой странице.',
  },
  {
  ...
  },
  {
    ...
    body: 'Создание НПС и локаций, генерация контента, проверка целостности данных — и вкладка «📖 Инструкции» с полным руководством пользователя прямо в приложении. Этот тур всегда можно перезапустить кнопкой «?» у логотипа.',
  },
];
