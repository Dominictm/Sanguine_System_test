...
Если в карточке заполнены поля «Хочет/Боится/Рычаг» — персонаж проактивен: реплики продвигают его цель, выдают страх намёками, а упоминание его рычага меняет тон.
${litStyle ? `\n# ЛИТЕРАТУРНЫЙ СТИЛЬ (system/rules/literary_style.md)\n${litStyle}\n` : ''}
